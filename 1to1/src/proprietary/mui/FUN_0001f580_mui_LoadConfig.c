...

{
  ...
  uVar2 = get_items_from_zipfile(acStack_18c,configitems);
...
LAB_0001fdc8:
  ...
  if (local_128[0] == '\0') {
    ...
    __isoc99_sscanf(local_128,&DAT_002dcf4c,&DAT_003af708);
  }
  ...
  if (local_128[0] == '\0') {
    ...
    __isoc99_sscanf(local_128,&DAT_002dcf4c,&DAT_003af70f);
  }
  ...
  if (local_128[0] == '\0') {
    if (m_ui == 1) {
      ...
      DAT_003af7c8._3_1_ = '!';
      DAT_003af7cc = DAT_003af7cc & 0xffffff00;
    }
    else {
