/* ============================================================
 * prosystem_Load   @ 0x002b6614   size=516B   callers=0
...
undefined4 prosystem_Load(char *param_1,int param_2)

{
  ...
  screen_w = 0x100;
  screen_x = 0;
  sprintf(acStack_120,"%s/cores/libemu_prosystem.so",work_path);
