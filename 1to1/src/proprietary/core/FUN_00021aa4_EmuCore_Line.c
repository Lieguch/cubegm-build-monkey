...

{
  ...
  if (param_2 != param_3) {
    mui_outputxy_t(DAT_003af29c,OutRect._8_4_,DAT_003af744 * param_2 + OutRect._12_4_,
                   (undefined1)DAT_003af730,DAT_003af734,acStack_118);
    return;
  }
  iVar1 = mui_outputxy_length_isra_19(OutRect._8_4_,(undefined1)DAT_003af738,acStack_118);
  EmuCore_Blank(OutRect._8_4_,DAT_003af744 * param_2 + OutRect._12_4_,iVar1 - OutRect._8_4_);
  mui_outputxy_t(DAT_003af29c,OutRect._8_4_,DAT_003af744 * param_2 + OutRect._12_4_,
                 (undefined1)DAT_003af738,DAT_003af73c,acStack_118);
  return;
}
