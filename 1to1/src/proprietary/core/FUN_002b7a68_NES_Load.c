/* ============================================================
 * NES_Load   @ 0x002b7a68   size=528B   callers=0
...
undefined4 NES_Load(char *param_1,int param_2)

{
  ...
  screen_w = 0x100;
  screen_x = 0;
  RARCH_LOG("Loading nes %s ... \r\n",param_1);
  sprintf(acStack_120,"%s/cores/libemu_nes.so",work_path);
