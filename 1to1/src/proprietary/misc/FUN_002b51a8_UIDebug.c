...

{
  ...
  local_58 = local_50;
  fVar14 = (float)VectorSignedToFloat(iVar6,(gh_byte)(in_fpscr >> 0x16) & 3);
  fVar15 = 60.0;
  if (pal_ntsc != 0) {
    fVar15 = 50.0;
  }
  ...
  if (1000000 < iVar6 - prev_time) {
    DispFrameCount = 0;
    fps0 = (float)VectorSignedToFloat(uVar3,(gh_byte)(in_fpscr >> 0x16) & 3);
    prev_time = iVar6;
  }
  dVar16 = (double)(fVar15 * fVar14 * 0.0625);
  sprintf((char *)local_58,"%.02f %.02f",SUB84(dVar16,0),(int)((gh_ulonglong)dVar16 >> 0x20),
          (double)fps0);
  ...
  if (uVar9 != 0) {
    ...
    do {
      ...
      do {
        uVar9 = 7;
        puVar5 = (gh_u2 *)(param_1 + iVar10);
        do {
          uVar2 = uVar9 & 0xff;
          uVar9 = uVar9 - 1;
          if (((int)(gh_uint)*pbVar12 >> uVar2 & 1U) == 0) {
            *puVar5 = 0;
          }
          else {
            *(gh_u2 *)((int)puVar5 + iVar10 + iVar13) = 0xffe0;
          }
          puVar5 = puVar5 + 1;
      ...
      uVar9 = (gh_uint)(gh_byte)local_58->tv_sec;
    } while (uVar9 != 0);
  }
  return;
}
