...
#include <limits.h>   /* INT_MAX (RET_COUNT_MAX) */
 ...
 */
/* Minimal stub definitions for libiconv internal types */
struct loop_funcs { int dummy; };
struct iconv_fallbacks { int dummy; };
...
#include "cp1256.h"
#include "cp1257.h"
/* #include "cp1258.h" */  /* 需 vietcomb.h 真实数据，暂跳过 */
#include "cp850.h"
#include "cp862.h"
#include "cp866.h"
#include "cp1131.h"
...
/* #include "iso2022_jpms.h" */  /* 需 cp932ext 真实数据，暂跳过 */
