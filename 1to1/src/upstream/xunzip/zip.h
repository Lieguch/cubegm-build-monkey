...
HZIP CreateZip(char *z,unsigned int len, const char *password);
...
ZRESULT ZipAdd(HZIP hz,const TCHAR *dstzn, char *src,unsigned int len);
...
HZIP CreateZipZ(char *z,unsigned int len, const char *password);
